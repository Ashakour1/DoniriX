  ...
  return (
    <main className="max-w-[1040px] mx-auto mt-12 min-h-screen">
      ...
      <div
                ...
                >
                    <div
                        className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#1815b3] to-[#c51685] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
                        style={{
                            clipPath:
